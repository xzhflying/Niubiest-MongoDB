...
<form method="post">
 	...
 	Precipitation: <input type="text" name="precipitation" value=-9999><br>
 	SnowDepth: <input type="text" name="snowdepth" value=-9999><br>
 	Temperature Max: <input type="text" name="tmax" value=189><br>
 	Temperature Mini:<input type="text" name="tmini" vlaue=-9999><br>
