''' This is a simple demo of weather analyze system
    ...
    Then output suitable cities' information.

    Entire project descriptions:
    Basic function:
        Users can select the location in which they prefer to arrange their plan.
        Users can choose a range of distance that they can tolerate. And a range of date during which they care about the weather
